...
![Pomegranate tree](../json/images/WEB-0729_pomegranate_tree.jpg)

*Pomegranate tree (Amnon s (Wikimedia Commons))*
...
![Pomegranate open](../json/images/WEB-0727_pomegranate.jpg)

*Pomegranate open (Susan Slater (Wikimedia Commons))*
...
1KI 7:18: Instead of “pomegranates,” some Hebrew manuscripts read “pillars” (*‘amudim* rather than *rimmonim*). HOTTP (Hebrew Old Testament Text Project (UBS)) favors *‘amudim* here but only with a “C” rating. Possible reasons for supposing there was a change of the text from *‘amudim* to *rimmonim* are:
