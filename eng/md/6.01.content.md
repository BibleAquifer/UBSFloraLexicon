...
![Anemone](../json/images/PTZ-0005_anemone.jpg)
...
The Greek word *krinon* in MAT 6:28; LUK 12:27 is now thought to refer to the crown anemone, the common poppy, or to a whole class of plants (see [6\.1\.1 Anemone (crown anemone)](#FLORA:6.1.1)).

![Lily flower](../json/images/WEB-0592_lily.jpg)

*Lily flower (Peganum from Henfield, England (Wikimedia Commons))*

Latin inherited the word *lilium* from Greek, and references to it in 2ES 2:19; 2ES 5:24 are generic. It is uncertain what type of lily is in view in these passages since the context is apocalyptic. In 2ES 2:19 lilies are paired with roses (see [6\.1\.4 Rose (Phoenician rose)](#FLORA:6.1.4)).
...
![Phoenician rose](../json/images/PTZ-0116_rose_phoenician.jpg)

*Phoenician rose (Ray Pritz (UBS))*
...
![Oleander](../json/images/PTZ-0105_oleander_flowers.jpg)
